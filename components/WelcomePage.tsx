  ...
  return (
    <AnimatePresence>
      <motion.main
        ...
        className="flex flex-col xl:flex-row  justify-around items-center h-svh w-full"
      >
        <div className="relative lg:text-8xl text-5xl group space-y-3 scale-x-110 transition-all font-bebas duration-150 cursor-pointer">
        ...
        <button className="motion-rotate-loop-[6deg] motion-loop-once motion-duration-[1000ms] motion-delay-[3ms] motion-delay-[0ms]/rotate motion-ease-spring-bounciest relative lg:text-6xl  inline-block font-bitcount group py-3 px-10  cursor-pointer text-3xl shadow-lg transition-all">
